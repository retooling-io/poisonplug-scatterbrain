"""
The import protection is implemented in the following manner ... //


"""
from miasm.arch.x86.arch import x86_64
...
"""----------------------Recover Imports for Headerless----------------------"""
...
"""--------------------Recover Imports for Non-Headerless--------------------"""
...
# @TODO: add cfg recovery support for the impconst. All it takes to find
#        it is to walk an import stub in full, as it will invoke the
#        decrypt routine. Can possibly even emulate the decryption of this
#        which is more costly but should generalize
