...
def _recover_all_dispatchers_via_emu(
    ...
    def _brute_find_all_calls(
        ...
        @TODO: add range check for the imgbuffer to only scan code sections
        """
    ...
    emu = EmulateIntel64()
    emu.map_shellcode(bytes(d.imgbuffer))
    emu.map_teb()
...
def _verify_dispatcher_pushfq(
    ...
    the encoded offset fetch at the call's return address.
