...
# -----------------------------------------------------------------------------
# register subsets to check all granularities of a register
RAX_SUBSET = [x86.X86_REG_RAX, x86.X86_REG_EAX,  x86.X86_REG_AX,   x86.X86_REG_AH, x86.X86_REG_AL]
RCX_SUBSET = [x86.X86_REG_RCX, x86.X86_REG_ECX,  x86.X86_REG_CX,   x86.X86_REG_CH, x86.X86_REG_CL]
RDX_SUBSET = [x86.X86_REG_RDX, x86.X86_REG_EDX,  x86.X86_REG_DX,   x86.X86_REG_DH, x86.X86_REG_DL]
RBX_SUBSET = [x86.X86_REG_RBX, x86.X86_REG_EBX,  x86.X86_REG_BX,   x86.X86_REG_BH, x86.X86_REG_BL]
RSP_SUBSET = [x86.X86_REG_RSP, x86.X86_REG_ESP,  x86.X86_REG_SP,   x86.X86_REG_SPL]
RBP_SUBSET = [x86.X86_REG_RBP, x86.X86_REG_EBP,  x86.X86_REG_BP,   x86.X86_REG_BPL]
RSI_SUBSET = [x86.X86_REG_RSI, x86.X86_REG_ESI,  x86.X86_REG_SI,   x86.X86_REG_SIL]
RDI_SUBSET = [x86.X86_REG_RDI, x86.X86_REG_EDI,  x86.X86_REG_DI,   x86.X86_REG_DIL]
R8_SUBSET  = [x86.X86_REG_R8,  x86.X86_REG_R8D,  x86.X86_REG_R8W,  x86.X86_REG_R8B]
R9_SUBSET  = [x86.X86_REG_R9,  x86.X86_REG_R9D,  x86.X86_REG_R9W,  x86.X86_REG_R9B]
R10_SUBSET = [x86.X86_REG_R10, x86.X86_REG_R10D, x86.X86_REG_R10W, x86.X86_REG_R10B]
R11_SUBSET = [x86.X86_REG_R11, x86.X86_REG_R11D, x86.X86_REG_R11W, x86.X86_REG_R11B]
R12_SUBSET = [x86.X86_REG_R12, x86.X86_REG_R12D, x86.X86_REG_R12W, x86.X86_REG_R12B]
R13_SUBSET = [x86.X86_REG_R13, x86.X86_REG_R13D, x86.X86_REG_R13W, x86.X86_REG_R13B]
R14_SUBSET = [x86.X86_REG_R14, x86.X86_REG_R14D, x86.X86_REG_R14W, x86.X86_REG_R14B]
R15_SUBSET = [x86.X86_REG_R15, x86.X86_REG_R15D, x86.X86_REG_R15W, x86.X86_REG_R15B]
IP_SUBSET  = [x86.X86_REG_EIP, x86.X86_REG_RIP]

def get_reg_subset(r):
    """Given a register id, see if it's part of a register subset.

    Useful in cases where you're not concerned about granularity and want
    to see what register one is working with.

    if insn.operands[op].reg/.value.reg in r_subset:
       match:
           ... ...
    """
    if r in RAX_SUBSET:   return RAX_SUBSET
    elif r in RCX_SUBSET: return RCX_SUBSET
    elif r in RDX_SUBSET: return RDX_SUBSET
    elif r in RBX_SUBSET: return RBX_SUBSET
    elif r in RSP_SUBSET: return RSP_SUBSET
    elif r in RBP_SUBSET: return RBP_SUBSET
    elif r in RSI_SUBSET: return RSI_SUBSET
    elif r in RDI_SUBSET: return RDI_SUBSET
    elif r in R8_SUBSET:  return R8_SUBSET
    elif r in R9_SUBSET:  return R9_SUBSET
    elif r in R10_SUBSET: return R10_SUBSET
    elif r in R11_SUBSET: return R11_SUBSET
    elif r in R12_SUBSET: return R12_SUBSET
    elif r in R13_SUBSET: return R13_SUBSET
    elif r in R14_SUBSET: return R14_SUBSET
    elif r in R15_SUBSET: return R15_SUBSET
